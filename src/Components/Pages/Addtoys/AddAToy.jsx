            ...
            <div className='boxed-container py-16'>
                <div style={{ borderRadius: '20px' }} className='drop-shadow-lg mx-auto bg-white'>
                    <div className='py-5 lg:py-8 px-5'>
                        <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded px-8 pt-6 pb-6 ">
                            ...
                            <div className="md:flex items-center md:space-x-4">
                                <div className='md:w-1/2 mb-3'>
                                    ...
                                    <input className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-[#26A8DF] focus:shadow-outline " {...register("sellerName")} type="text" placeholder="type your name" required />
                                </div>
                                <div className='md:w-1/2 mb-3'>
                                    <label className="block text-gray-700 text-sm font-bold mb-2">
                                        Seller Email
                                    </label>
                                    <input className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-[#26A8DF] focus:shadow-outline " {...register("sellerEmail")} type="email" placeholder="yourmail@gmail.com" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-[#26A8DF] focus:shadow-outline " id="txtid" {...register("detailsDes")} rows="5" cols="50" maxLength="200"></textarea>
                            </div>
